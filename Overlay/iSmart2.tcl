...
proc create_root_design { parentCell } {
  ...
  # Create instance: mobilenet_0, and set properties
  set mobilenet_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:mobilenet:1.0 mobilenet_0 ]
  ...
  connect_bd_intf_net -intf_net mobilenet_0_m_axi_IMG [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins mobilenet_0/m_axi_IMG]
  connect_bd_intf_net -intf_net mobilenet_0_m_axi_INPUT_r [get_bd_intf_pins axi_smc_1/S00_AXI] [get_bd_intf_pins mobilenet_0/m_axi_INPUT_r]
  connect_bd_intf_net -intf_net mobilenet_0_m_axi_OUTPUT_r [get_bd_intf_pins axi_smc_2/S00_AXI] [get_bd_intf_pins mobilenet_0/m_axi_OUTPUT_r]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins mobilenet_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins axi_smc_2/aresetn] [get_bd_pins mobilenet_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces mobilenet_0/Data_m_axi_IMG] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces mobilenet_0/Data_m_axi_INPUT_r] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces mobilenet_0/Data_m_axi_OUTPUT_r] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mobilenet_0/s_axi_AXILiteS/Reg] SEG_mobilenet_0_Reg
